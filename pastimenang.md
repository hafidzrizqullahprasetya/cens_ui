...
## 💡 KONSEP INTI: "Modular Eco-Viaduct berbasis Baja Bergelombang & Matras Bambu"
...
*   **Cara Mewujudkannya:**
    ...
    3.  **Sensor Cerdas Tahan Bencana:** Pasang sensor ultrasonik mini di atas gorong-gorong baja yang murni ditenagai **Panel Surya** dan mentransmisikan data debit air melalui **Radio Gelombang Panjang (LoRaWAN)**, sehingga tidak peduli listrik PLN/sinyal Telkomsel mati, data tetap terkirim ke BNPB!
*   **Keuntungan (Poin Juri):** Ekonomi warga pulih lewat anyaman bambu/pengisian karung (Sosial terpenuhi), konstruksi tahan gempa/amblas (Sipil terpenuhi), dan ada unsur peringatan dini berteknologi mutakhir yang tahan krisis (Nilai Inovasi 25% terpenuhi sempurna!).

---

## 🎯 KENAPA IDE GABUNGAN INI TIDAK ADA CELAHNYA?
...
3.  *Juri:* "IoT kalian omong kosong! Kalau banjir di pedalaman Sumatera listrik dan sinyal pasti mati."
    *Jawaban:* "Tepat sekali Bapak/Ibu. Karena itu sensor ultrasonik struktural kami 100% menggunakan *Solar Panel* mandiri dan *LoRaWAN* (gelombang radio jarak jauh) pelacak cuaca, bukan *provider* GSM standar. Infrastruktur kami adalah wujud cerdas tanggap bencana tanpa blank-spot."

---

## 📚 TUGAS KELOMPOK (Tolong Cari Jurnal Tentang Ini!)

Untuk memperkuat esai kalian dan mendapatkan nilai **Data dan Sumber (10%) sert Analisis Masalah (20%)**, kalian harus membungkam juri dengan bukti ilmiah dari *Google Scholar*, *ResearchGate*, atau Scopus.
...
Satukan jurnal-jurnal abstrak (inti teorinya saja) yang kalian temukan. Nanti akan saya racik menjadi referensi *(citations)* bergaya Harvard di paragraf pembahasan `jawaban.md` agar esai kalian terlihat seperti *"dikerjakan oleh analis profesional"*. Gas!
